...
create table ac_account(
    ...
    other_en_type   tinyint default 0                   comment '预付/信用实体类型 1:平台 2:服务商 3:商家 4:师傅',
    other_en_id     int default 0                       comment '预付/信用实体ID',
    ...
    credit_amt      decimal(12,2) default 0.00          comment '信用账户实时额度',
...
create table ac_pay_flow(
    ...
    exchange_rate   decimal(12,6) not null              comment '换算率',
    pay_amt         decimal(12,2) not null              comment '实付金额',
...
create table ac_pay_type(
    ...
    exchange_rate   decimal(12,6) not null default 1.00 comment '换算率',
...
insert into base_dict ( bd_type, bd_label, bd_value ) values ( '记账类型', '预付', 2 );
insert into base_dict ( bd_type, bd_label, bd_value ) values ( '记账类型', '信用', 3 );
